...
public class CPainting extends Canvas implements MouseListener {
  ...
  //Utiliser final pour accélérer la vitesse
  ...
  public CPainting(Dimension pDimension, PaintingAnts pApplis) {
    ...
    //Utiliser l'objet anonyme pour faciliter la récupération de la mémoire
    ...
    synchronized (mMutexCouleurs) {
      for (i = 0; i != mDimension.width; i++) {
        for (j = 0; j != mDimension.height; j++) {
          //Avec une valeur fixe, on peut diminuer le nombre d'objets considérablement
  ...
  public void setCouleur(int x, int y, int c, int pTaille) {
    int i, j, k, l, m, n;
    float R, G, B;
    //Utiliser le nombre entier pour remplacer l'objet
    int lColor;
        ...
        case 1:
          ...
          for (i = 0; i < 3; i++) {
            for (j = 0; j < 3; j++) {
              ...
              //Utiliser l'objet anonyme pour faciliter la récupération de memoire
